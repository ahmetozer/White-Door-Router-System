...
#cd
alias wh-set= 'sudo cp -r ../root/* output/host/ && sudo cp -r ../root/* output/target/ && chown -r whitedoor:whitedoor output/target && sudo chown -r whitedoor:whitedoor output/host'
